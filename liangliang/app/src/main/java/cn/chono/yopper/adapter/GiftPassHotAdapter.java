 ...
 */
public class GiftPassHotAdapter extends BaseRecyclerAdapter<GiftPassHotAdapter.NewHolderView> {
    ...
    public GiftPassHotAdapter(Context c) {
    ...
    @Override
    public GiftPassHotAdapter.NewHolderView getViewHolder(View view) {
    ...
    @Override
    public GiftPassHotAdapter.NewHolderView onCreateViewHolder(ViewGroup parent, int viewType, boolean isItem) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_gift, parent, false);
        return new NewHolderView(view);
    }

    @Override
    public void onBindViewHolder(GiftPassHotAdapter.NewHolderView holder, int position, boolean isItem) {
        ...
        holder.itemGiftLy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                RxBus.get().post("onClickPassHotGift",new CommonEvent<>(giftDto));
            }
        });
