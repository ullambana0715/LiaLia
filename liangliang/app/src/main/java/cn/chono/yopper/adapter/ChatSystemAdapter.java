...
public class ChatSystemAdapter extends BaseListAdapter<ChatDto> {
    ...
    public ChatSystemAdapter(Context context, List<ChatDto> msgList, String Mid, int userId, String Jid, int targetUserId) {
    ...
    public View bindView(final int position, View convertView, ViewGroup parent) {
        ...
        if (viewholder.iv_avatar != null) {
            ...
            if (!((Activity) mContext).isFinishing()) {
                Glide.with(mContext).load(R.drawable.application_icon).bitmapTransform(transformation).into(viewholder.iv_avatar);
            }
        }
