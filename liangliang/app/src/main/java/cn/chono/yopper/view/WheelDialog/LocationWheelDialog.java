...
public class LocationWheelDialog extends Dialog {
    ...
    private AddressTextAdapter one_wheelDialogAdapter, two_wheelDialogAdapter;


    private String strProvince = "上海";
    private String strCity = "普陀区";
    ...
    public LocationWheelDialog(Context context, String oneSelectData, String twoSelectData, OnWheelListener onWheelListener) {
        super(context, R.style.dialog_BOT_style);

        if (!TextUtils.isEmpty(oneSelectData))
            strProvince = oneSelectData;

        if (!TextUtils.isEmpty(twoSelectData))
        strCity = twoSelectData;
    ...
    private void initView() {
        ...
        one_wheelDialogAdapter = new AddressTextAdapter(getContext(), arrProvinces, getProvinceItem(strProvince), maxsize, minsize);


        one_wheelView.setVisibleItems(5);
        one_wheelView.setViewAdapter(one_wheelDialogAdapter);

        LogUtils.e("-----"+strProvince);
        LogUtils.e("-----"+strCity);

        one_wheelView.setCurrentItem(getProvinceItem(strProvince));
        setTextviewSize(strProvince, one_wheelDialogAdapter);
        ...
        one_wheelView.addChangingListener(new OnWheelChangedListener() {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                ...
                LogUtils.e("-----addChangingListener");

                String currentText = (String) one_wheelDialogAdapter.getItemText(wheel.getCurrentItem());
                strProvince = currentText;
                setTextviewSize(currentText, one_wheelDialogAdapter);


                String[] citys = mCitisDatasMap.get(currentText);
                initCitys(citys);

                two_wheelDialogAdapter = new AddressTextAdapter(getContext(), arrCitys, 0, maxsize, minsize);
                two_wheelView.setVisibleItems(5);
                two_wheelView.setViewAdapter(two_wheelDialogAdapter);
                two_wheelView.setCurrentItem(0);

                if (null != onWheelListener) {
                    onWheelListener.onWeelListener(strProvince);
                    onWheelListener.onWeelListener(strProvince, strCity);
        ...
        one_wheelView.addScrollingListener(new OnWheelScrollListener() {
            ...
            public void onScrollingStarted(WheelView wheel) {
                ...
                LogUtils.e("-----onScrollingStarted");
            }

            @Override
            public void onScrollingFinished(WheelView wheel) {

                LogUtils.e("-----onScrollingFinished");
                String currentText = (String) one_wheelDialogAdapter.getItemText(wheel.getCurrentItem());
                setTextviewSize(currentText, one_wheelDialogAdapter);
        ...
        two_wheelDialogAdapter = new AddressTextAdapter(getContext(), arrCitys, getCityItem(strCity), maxsize, minsize);
        two_wheelView.setVisibleItems(5);
        two_wheelView.setViewAdapter(two_wheelDialogAdapter);
        two_wheelView.setCurrentItem(getCityItem(strCity));
        setTextviewSize(strCity, two_wheelDialogAdapter);

        two_wheelView.addChangingListener(new OnWheelChangedListener() {
            @Override
            public void onChanged(WheelView wheel, int oldValue, int newValue) {

                LogUtils.e("-----======addChangingListener");

                String currentText = (String) two_wheelDialogAdapter.getItemText(wheel.getCurrentItem());
                strCity = currentText;
                setTextviewSize(currentText, two_wheelDialogAdapter);
        ...
        two_wheelView.addScrollingListener(new OnWheelScrollListener() {
