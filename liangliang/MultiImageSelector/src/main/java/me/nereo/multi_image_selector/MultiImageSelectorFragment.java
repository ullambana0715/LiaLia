        ...
        if (ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    ToastUtil.showToast(getActivity(), getActivity().getResources().getString(R.string.mis_error_image_not_exist));


                }
            } else {

                ToastUtil.showToast(getActivity(), getActivity().getResources().getString(R.string.mis_msg_no_camera));
            ...
            if (mode == MODE_MULTI) {
                ...
                if (resultList.contains(image.path)) {
                    ...
                    if (selectImageCount() == resultList.size()) {
                        ...
                        String msg = "最多只能选择" + selectImageCount() + "张哦";
                    ...
                    if (w == 0 && h == 0) {
                        ...
                        ToastUtil.showToast(getActivity(), "图片质量过低");
