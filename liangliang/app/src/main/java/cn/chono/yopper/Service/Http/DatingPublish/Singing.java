 ...
 */
public class Singing implements Parcelable {
    ...
    public static final Parcelable.Creator<Singing> CREATOR = new Parcelable.Creator<Singing>() {
        @Override
        public Singing createFromParcel(Parcel source) {
            return new Singing(source);
        }

        @Override
        public Singing[] newArray(int size) {
            return new Singing[size];
        }
    };
}
