 ...
 */
public class CCPageAdapter<T> extends PagerAdapter {
...
//        if(onItemClickListener != null) view.setOnClickListener(onItemClickListener);
    ...
    public CCPageAdapter(ViewHolderCreator holderCreator, List<T> datas) {
