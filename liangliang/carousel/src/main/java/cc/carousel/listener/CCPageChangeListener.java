 ...
 * 翻页指示器适配器
 */
public class CCPageChangeListener implements ViewPager.OnPageChangeListener {
    private ArrayList<ImageView> pointViews;
    private int[] page_indicatorId;
    private ViewPager.OnPageChangeListener onPageChangeListener;
    public CCPageChangeListener(ArrayList<ImageView> pointViews, int page_indicatorId[]){
