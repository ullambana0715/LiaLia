 ...
 */
public class ThreeCityWheelDialog extends Dialog{
    private OnThreeSelectedListener onSelectedListener;
    ...
    int distIndex = 0;
    List<String> distArray = new ArrayList<>();

    public ThreeCityWheelDialog(Context context) {
        super(context);
    }

    public ThreeCityWheelDialog(Context context, int theme) {
        super(context, theme);
    }

    protected ThreeCityWheelDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }

    public ThreeCityWheelDialog(final Context context,OnThreeSelectedListener listener) {
        super(context, R.style.dialog_BOT_style);
        onSelectedListener = listener;
        getAddressNames();
        View view =   LayoutInflater.from(context).inflate(R.layout.threewheellayout, null);
        ...
        provinces_wheel = (WheelView)view.findViewById(R.id.edit_hometown_provinces_wheel);
        city_wheel= (WheelView)view.findViewById(R.id.edit_hometown_city_wheel);
        district_wheel = (WheelView)view.findViewById(R.id.edit_hometown_district_wheel);
        ...
        distArray = secondWheel.get(firstWheel.get(province.get(0)).get(0));
        distIndex = 0;
        provinceAdapter = new AddressTextAdapter(context, province, 0, maxsize, minsize);
        provinces_wheel.setVisibleItems(3);
        ...
        provinces_wheel.addChangingListener(new OnWheelChangedListener() {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                ...
                cityAdapter = new AddressTextAdapter(context, cityArray, 0, maxsize, minsize);
                city_wheel.setVisibleItems(3);
                ...
                districtAdapter = new AddressTextAdapter(context, districtArray, 0, maxsize, minsize);
                district_wheel.setVisibleItems(3);
                district_wheel.setViewAdapter(districtAdapter);
                district_wheel.setCurrentItem(0);

                distArray = secondWheel.get(firstWheel.get(province.get(wheel.getCurrentItem())).get(0));
                onSelectedListener.OnThreeSelectedListener(province_name, cityAdapter.getItemText(city_wheel.getCurrentItem()) + "",
                        districtAdapter.getItemText(district_wheel.getCurrentItem())+"",distArray.get(0).substring(distArray.get(0).indexOf("|")+1));
            }
        });

        cityAdapter = new AddressTextAdapter(context, firstWheel.get(province.get(0)), 0, maxsize, minsize);
        city_wheel.setVisibleItems(3);
        city_wheel.setViewAdapter(cityAdapter);
        city_wheel.setCurrentItem(0);
        ...
        city_wheel.addChangingListener(new OnWheelChangedListener() {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                ...
                distArray = districtArray;
                districtAdapter = new AddressTextAdapter(context, districtArray, 0, maxsize, minsize);
                district_wheel.setVisibleItems(3);
                district_wheel.setViewAdapter(districtAdapter);
                district_wheel.setCurrentItem(0);
                onSelectedListener.OnThreeSelectedListener(province_name, cityAdapter.getItemText(city_wheel.getCurrentItem()) + "",
                        districtAdapter.getItemText(district_wheel.getCurrentItem()) + "", distArray.get(distIndex).substring(distArray.get(distIndex).indexOf("|") + 1));
            }
        });

        districtAdapter = new AddressTextAdapter(context, secondWheel.get(firstWheel.get(province.get(0)).get(0)), 0, maxsize, minsize);
        district_wheel.setVisibleItems(3);
        district_wheel.setViewAdapter(districtAdapter);
        district_wheel.setCurrentItem(0);
        ...
        district_wheel.addChangingListener(new OnWheelChangedListener() {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                ...
                distIndex = wheel.getCurrentItem();
