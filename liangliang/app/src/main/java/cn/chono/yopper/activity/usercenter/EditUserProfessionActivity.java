...
public class EditUserProfessionActivity extends MainFrameActivity implements OnClickListener {
    ...
    private void setSelectedBg(String profess_str) {
        ...
        if (profess_str.equals("学生")) {
            ...
            edit_pro_student_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));

            edit_pro_dagong_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_dagong_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_siying_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_siying_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_xiaoshou_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_xiaoshou_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_gongchengshi_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_gongchengshi_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_zhiyuan_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_zhiyuan_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_guanli_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_guanli_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_jingcha_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_jingcha_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_yisheng_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_yisheng_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_yanyuan_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_yanyuan_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_mote_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_mote_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_jiaoshi_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_jiaoshi_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_shejishi_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_shejishi_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_guwen_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_guwen_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_it_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_it_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_fengtou_tv.setBackgroundResource(R.drawable.profession_normal);
            edit_pro_fengtou_tv.setTextColor(this.getResources().getColor(R.color.color_565656));
        ...
        if (profess_str.equals("打工族")) {
            ...
            edit_pro_student_tv.setTextColor(this.getResources().getColor(R.color.color_565656));

            edit_pro_dagong_tv.setBackgroundResource(R.drawable.profession_selected);
            edit_pro_dagong_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("私营业主")) {
            ...
            edit_pro_siying_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("销售")) {
            ...
            edit_pro_xiaoshou_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("工程师")) {
            ...
            edit_pro_gongchengshi_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("公司职员")) {
            ...
            edit_pro_zhiyuan_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("中层管理者")) {
            ...
            edit_pro_guanli_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("警察")) {
            ...
            edit_pro_jingcha_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("医生")) {
            ...
            edit_pro_yisheng_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("演艺人员")) {
            ...
            edit_pro_yanyuan_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("模特")) {
            ...
            edit_pro_mote_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("教师")) {
            ...
            edit_pro_jiaoshi_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("设计师")) {
            ...
            edit_pro_shejishi_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("投资顾问")) {
            ...
            edit_pro_guwen_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("互联网从业者")) {
            ...
            edit_pro_it_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
        ...
        if (profess_str.equals("风险投资人")) {
            ...
            edit_pro_fengtou_tv.setTextColor(this.getResources().getColor(R.color.color_ffffff));
